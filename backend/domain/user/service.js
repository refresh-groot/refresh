...
module.exports = {
  ...
  googleLogin: async (code) => {
    const GOOGLE_CLIENT_ID = '903322860212-hpnv3iafvc82p19jk3res2thj8tdvsku.apps.googleusercontent.com';
    const GOOGLE_CLIENT_SECRET = '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';
    const GOOGLE_REDIRECT_URI = 'http://223.130.157.123.nip.io:8080/api/user/auth/google/callback';
  ...
  naverLogin: async (code, state) => {
    const NAVER_CLIENT_ID = 'HpGYrW8mOYQAinxcaFcR';
    const NAVER_CLIENT_SECRET = 'Rxu6IM43bw';
  ...
  githubLogin: async (code) => {
    const GITHUB_CLIENT_ID = 'Ov23lijQahA3wGcLU83z';
    const GITHUB_CLIENT_SECRET = '85e9d6b22b861b13c39b03a3a258265b483494ab';
